...
/*-------------------------------------------------------------------------------------------------------------
final pipe layout
P( 1): 269 nodes,   1466.0 gates,  174 pipeRegs (  102 pipes,  314 states, 1 FBs), IO(  0, 28),GIO( 5, 0),D(  35.0),pd( 0, 0)
------------------------------------------ explicit pipe boundary -------------------------------------------
P( 2): 118 nodes,    833.0 gates,    0 pipeRegs (    0 pipes,  112 states, 0 FBs), IO( 13,  0),GIO( 1, 3),D(  34.0),pd( 0, 1)
-------------------------------------------------------------------------------------------------------------
Total: 387 nodes,   2299.0 gates,  174 pipeRegs (  102 pipes,  426 states, 1 FBs), I( 13),O( 28),D(  69.0),maxD(  35.0 :   35.0)
Total    5737.5 gates (combined) :   2299.0 (comb-gates) +  529 (reg-bits) * 6.50 (gates/FF) + 0 memBits
-------------------------------------------------------------------------------------------------------------*/

/*-------------------------------------------------------------------------------------------------------------
[TOTAL] 387 nodes, 5,737.5 totalGates, 2,299 combGates, 529 regBits, 0 memBits, 0 totalMemBits
...
(  9) [ 15.750 -  17.500] : area(    4.0,  196.0),latency(    0.0,    7.0),carry(    4.0,    0.0),foSum(   72.000,  10.421,   5.772,    0),foAve(24.000,3.474,1.924,0.000),foStd(17.594,1.994,0.961),foNormL2(  67.186),nodeCount(     3)
...
( 13) [ 22.750 -  24.500] : area(   18.0,    0.0),latency(    4.0,    0.0),carry(    0.0,    0.0),foSum(   19.000,   8.657,   7.000,    0),foAve(3.800,1.731,1.400,0.000),foStd(1.534,0.401,0.219),foNormL2(  11.446),nodeCount(     5)
...
( 16) [ 28.000 -  29.750] : area(   58.0,    3.0),latency(   46.0,    3.0),carry(    0.0,    0.0),foSum(  222.000,  79.005,  62.596,    0),foAve(4.111,1.463,1.159,0.000),foStd(1.189,0.191,0.106),foNormL2(  70.937),nodeCount(    54)
( 17) [ 29.750 -  31.500] : area(  213.0,    0.0),latency(   48.0,    0.0),carry(    0.0,    0.0),foSum(  230.000,  82.385,  67.030,    0),foAve(4.107,1.471,1.197,0.000),foStd(1.463,0.186,0.094),foNormL2(  87.510),nodeCount(    56)
( 18) [ 31.500 -  33.250] : area(   99.0,   32.0),latency(   19.0,    1.0),carry(    0.0,    0.0),foSum(   52.000,  24.485,  21.695,    0),foAve(1.926,0.907,0.804,0.000),foStd(1.140,0.202,0.127),foNormL2(  32.373),nodeCount(    27)
( 19) [ 33.250 -  35.000] : area(    0.0,    0.0),latency(    0.0,    0.0),carry(    0.0,    0.0),foSum(    0.000,   0.000,   0.000,    0),foAve(0.000,0.000,0.000,0.000),foStd(0.000,0.000,0.000),foNormL2(   0.000),nodeCount(     4)
*/
...
(_GPIO_AXI4L_step : 5731.0 gates, 360 nodes) : 2299.0 comb-gates + 102 pipeBits + 426 stateBits + 0 FBBits
  (excl.sub-modules : 1468.5 gates, 142 nodes) : 526.0 comb-gates + 49 pipeBits + 96 stateBits + 0 FBBits
  ...
  (_2_update_refresh : 1537.5 gates, 44 nodes) : 1141.0 comb-gates + 42 pipeBits + 19 stateBits + 0 FBBits
    (excl.sub-modules : 1486.5 gates, 31 nodes) : 1090.0 comb-gates + 42 pipeBits + 19 stateBits + 0 FBBits
...
*********************************************************
   _2_update_refresh :    1486.5 gates(acc:  25.94%),    1090.0 comb-gates +   42 pipeBits +  19 stateBits +   0 FBBits
    _GPIO_AXI4L_step :    1468.5 gates(acc:  51.56%),     526.0 comb-gates +   49 pipeBits +  96 stateBits +   0 FBBits
      _3_4_fsmUser_1 :     874.0 gates(acc:  66.81%),      29.0 comb-gates +    0 pipeBits + 130 stateBits +   0 FBBits
        _3_2_fsmRead :     767.0 gates(acc:  80.20%),     260.0 comb-gates +    4 pipeBits +  74 stateBits +   0 FBBits
       _3_3_fsmWrite :     746.5 gates(acc:  93.22%),     246.0 comb-gates +    2 pipeBits +  75 stateBits +   0 FBBits
**********************************************************/
...
module GPIO_AXI4L_step_no_mem   (
  ...
  reg       _p1_CM_143, _p1_CP_GPIO_AXI4L_step_B08_F1, 
    _p1_CP_fsmRead_B11_F1_B12_F1, _p1_CP_fsmRead_B12_F2_B14_F2, 
    _p1_CP_fsmWrite_B13_F2, _p1_CP_fsmWrite_B22_F2, _p1_G_dbg_wfi, 
    _p1_GPIO_AXI4L_step_pSetup, _p1_QC_231;
  reg[ 2:0] _p1_I_update_refresh_B1_2;
  ...
  reg       _p1_DFB_G__this_burst_end_r/*prv*/, _p1_DFB_G__this_digit_mode/*prv*/, 
    ...
    _p1_DFB_G__this_out_rdat_valid/*prv*/;
...
assign     G_axi_rdat_s_resp    =  G__this_out_rdat_resp/*prv*/            ; // DSO.GRP.5 <B>(comb-Out) (NL) [F(0.0)<0>,B(0.0)<0>] <0,0> [U0] P2 OP(assign:=)(./rv32_io.h:L155)[AXI4L::CH::RDAT::SL::set]
...
wire[ 7:0] I_GPIO_AXI4L_step_B02_1 =  G__this_an/*prv*/ ^ 8'hff            ; //  <B>(comb-Out) (NL) [F(0.0)<0>,B(0.0)<0>] <0,255> [U8] P2 OP(xor:^)(./rv32_io.h:L663)[GPIO_AXI4L::step]
assign     G_gpio_pin_seg7_an   =  I_GPIO_AXI4L_step_B02_1                 ; // DSO.GRP.6 <B>(comb-Out) (NL) [F(0.0)<0>,B(0.0)<0>] <0,255> [U8] P2 OP(assign:=)(./rv32_io.h:L663)[GPIO_AXI4L::step]
...
wire[31:0] I_fsm_0_0_B5_3       =  G__this_cycle/*prv*/ + 32'h1            ; // GRP.8(L2.0+C32.0+A96.0+fo1+ld[1]) [F(34.0,2.0)<0>,B(2.0,34.0)<0>] <0,4294967295> [U32] P2 OP(add:+)(./rv32_io.h:L289)[AXI4L::SlaveFSM::fsm]
wire[ 7:0] I_update_refresh_B7_2 =  8'h1 << {5'b0,_p1_I_update_refresh_B1_2}; //  <B>(L6.0+A6.0+fo1+ld[3:1]+S) [F(6.0)<0>,B(6.0)<0>] <1,128> [U8] P2 OP(shl:<<)(./rv32_io.h:L657)[GPIO_AXI4L::update_refresh]
wire[ 6:0] G_HIDDEN_GLOBAL_49_0 =  7'h3f                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_1 =  7'h6                                    ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_2 =  7'h5b                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_3 =  7'h4f                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_4 =  7'h66                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_5 =  7'h6d                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_6 =  7'h7d                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_7 =  7'h27                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_8 =  7'h7f                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_9 =  7'h6f                                   ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_10 =  7'h77                                  ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_11 =  7'h7c                                  ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_12 =  7'h39                                  ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_13 =  7'h5e                                  ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
wire[ 6:0] G_HIDDEN_GLOBAL_49_14 =  7'h79                                  ; // WA.GRP.3 <B>(NL) [F(0.0)<0>,B(13.0)<0>] <6,127> [U7] P2 OP(assign:=)[GPIO_AXI4L::step]
...
wire[ 6:0] AD_9 = _WIRE_ARRAY_7_15( N_213,
                                    G_HIDDEN_GLOBAL_49_0,
                                    G_HIDDEN_GLOBAL_49_1,
                                    G_HIDDEN_GLOBAL_49_2,
                                    G_HIDDEN_GLOBAL_49_3,
                                    G_HIDDEN_GLOBAL_49_4,
                                    G_HIDDEN_GLOBAL_49_5,
                                    G_HIDDEN_GLOBAL_49_6,
                                    G_HIDDEN_GLOBAL_49_7,
                                    G_HIDDEN_GLOBAL_49_8,
                                    G_HIDDEN_GLOBAL_49_9,
                                    G_HIDDEN_GLOBAL_49_10,
                                    G_HIDDEN_GLOBAL_49_11,
                                    G_HIDDEN_GLOBAL_49_12,
                                    G_HIDDEN_GLOBAL_49_13,
                                    G_HIDDEN_GLOBAL_49_14); // WA.GRP.3 <FB>(L8.0+A196.0+fo2+ld[1:15]+S) [F(20.0)<1>,B(13.0)<0>] <06,7f> [U7] P2 OP(addr:[])(./rv32_io.h:L625)[GPIO_AXI4L::step]
...
wire[15:0] N_234                =  G__this_din/*prv*/                      ; // (comb-Out/FFSink) (NL) [F(0.0)<0>,B(0.0)<0>] <0,65535> [U16] P2 OP(assign:=)(./rv32_io.h:L671)[GPIO_AXI4L::step]
  ...
  always @ (posedge clk) if (rst_n) begin
    if (_p1_CP_fsmRead_B11_F1_B12_F1)  /// format string conversion : ("[%6d] gpio.din = (%08x)\n") --> ("[%6d] gpio.din = (%08h)\n")
$write("[%6d] gpio.din = (%08h)\n", _p1_DFB_G__this_clk/*prv*/, G__this_din/*prv*/); //  <B*>(fo2) [F(0.0)<0>,B(0.0)<0>] <0,0> [U0] ZLB(64) P2(./rv32_io.h:L597)[GPIO_AXI4L::devRead]
    if (_p1_CP_fsmWrite_B13_F2      )  /// format string conversion : ("[%6d] gpio.dout[%d] = (%08x)\n") --> ("[%6d] gpio.dout[%d] = (%08h)\n")
$write("[%6d] gpio.dout[%d] = (%08h)\n", _p1_DFB_G__this_clk/*prv*/, _p1_I_devWrite_0_B1_1, _p1_G_axi_wdat_m_data); //  <B*> [F(0.0)<0>,B(0.0)<0>] <0,0> [U0] ZLB(64) P2(./rv32_io.h:L606)[GPIO_AXI4L::devWrite]
...
$write("[%6d] gpio.dout[%d] = (%08h)\n", _p1_DFB_G__this_clk/*prv*/, _p1_I_devWrite_0_B1_1, _p1_G_axi_wdat_m_data); //  <B*> [F(0.0)<0>,B(0.0)<0>] <0,0> [U0] ZLB(64) P2(./rv32_io.h:L606)[GPIO_AXI4L::devWrite]
  ...
  if (rst_n == 1'b0) begin
    ...
    if (_p1_CM_143) begin
      G__this_out_rdat_data <= DM_142; // GRP.17 <B>(ld[32:1]+S+@) [F(3.0)<0>,B(0.0)<0>] <0,4294967295> [U32] P2 OP(clk:@)(./rv32_io.h:L155)[AXI4L::SlaveFSM::fsmRead]
      G__this_out_rdat_resp <= 1'h0  ; // GRP.18 <B>(ld[1:1]+S+@) [F(0.0)<0>,B(0.0)<0>] <0,0> [U0] P2 OP(clk:@)(./rv32_io.h:L155)[AXI4L::SlaveFSM::fsmRead]
    end /// (_p1_CM_143)
    if (ROOT_CP) begin
      G__this_cycle <= I_fsm_0_0_B5_3                              ; // GRP.8(ld[32:1]+S+@) [F(34.0)<0>,B(0.0)<0>] <0,4294967295> [U32] P2 OP(clk:@)(./rv32_io.h:L289)[AXI4L::SlaveFSM::fsm]
    ...
    if (_p1_CP_GPIO_AXI4L_step_B08_F1) begin
      G__this_an    <= I_update_refresh_B7_2; // GRP.12 <B>(ld[8:1]+S+@) [F(6.0)<0>,B(0.0)<0>] <0,128> [U8] P2 OP(clk:@)(./rv32_io.h:L657)[GPIO_AXI4L::update_refresh]
      G__this_digit <= DM_229               ; // GRP.23 <B>(ld[8:1]+S+@) [F(25.0)<1>,B(0.0)<0>] <0,255> [U8] P2 OP(clk:@)(./rv32_io.h:L0)[GPIO_AXI4L::update_refresh]
    end /// (_p1_CP_GPIO_AXI4L_step_B08_F1)
  end /// reg-assignments
  end /// always @ ...
...
wire       CP_fsmRead_B02_F4    =  N_004 == 2'h1                           ; // GRP.25 <B>(L1.0+A1.0+fo7+ld[1]+S) [F(1.0)<0>,B(5.0)<0>] <0,1> [U1] P1 OP(eq:==)(rv32_io.cpp:L499)[AXI4L::SlaveFSM::fsmRead]
...
wire       QC_231               =  I_fsmRead_B11_3 | QC_230                ; // GRP.25 <FB>(L1.0+A1.0+fo2+ld[1:1]) [F(2.0)<0>,B(5.0)<0>] <0,1> [U1] P1 OP(or:|)(./rv32_io.h:L595)(rv32_io.cpp:L514)[AXI4L::SlaveFSM::fsmRead]
...
wire       CM_143           =  CP_fsmRead_B12_F2_B14_F2 | CP_fsmRead_B02_F8; // GRP.25 <FB>(L1.0+A1.0+fo2+ld[1:1]) [F(5.0)<0>,B(1.0)<0>] <0,1> [U1] P1 OP(or:|)(./rv32_io.h:L155)[AXI4L::SlaveFSM::fsmRead]
...
wire       CP_GPIO_AXI4L_step_B08_F1 =  CP_GPIO_AXI4L_step_B07_F1 & I_GPIO_AXI4L_step_B08_2; //  <B>(L1.0+A1.0+fo3+ld[1:1]) [F(5.0)<0>,B(1.0)<0>] <0,1> [U1] P1 OP(and:&)(./rv32_io.h:L685)[GPIO_AXI4L::step]
wire[ 3:0] I_update_refresh_B1_1 =  {1'b0,G__this_digit_idx/*prv*/} + 4'h1 ; // GRP.11 <B>(L2.0+C4.0+A12.0+fo67+ld[1]) [F(6.0,2.0)<0>,B(14.0,18.0)<0>] <1,8> [U4] P1 OP(add:+)(./rv32_io.h:L645)[GPIO_AXI4L::update_refresh]
...
wire       CP_fsmRead_B11_F1_B12_F1 =  CP_fsmRead_B02_F4 & QC_231          ; //  <FB>(L1.0+A1.0+ld[1:1]) [F(3.0)<0>,B(1.0)<0>] <0,1> [U1] P1 OP(and:&)(rv32_io.cpp:L515,L515)[AXI4L::SlaveFSM::fsmRead]
  ...
  if (rst_n == 1'b0) begin
    ...
    _p1_CP_fsmRead_B11_F1_B12_F1           <= 0;
    ...
    _p1_CP_fsmRead_B11_F1_B12_F1           <= CP_fsmRead_B11_F1_B12_F1       ; /*   1 bits */
    ...
    _p1_I_update_refresh_B1_2              <= I_update_refresh_B1_2          ; /*   3 bits */
  ...
  if (rst_n == 1'b0) begin
    ...
    if (ROOT_CP                  )  G__this_clk          <= I_GPIO_AXI4L_step_B12_3; // GRP.9 <B>(ld[32:1]+S+@) [F(34.0)<0>,B(0.0)<0>] <0,4294967295> [U32] P1 OP(clk:@)(./rv32_io.h:L692)[GPIO_AXI4L::step]
    if (CP_GPIO_AXI4L_step_B08_F1)  G__this_digit_idx    <= I_update_refresh_B1_2  ; // GRP.11 <B>(ld[3:1]+S+@) [F(6.0)<0>,B(0.0)<0>] <0,7> [U3] P1 OP(clk:@)(./rv32_io.h:L658)[GPIO_AXI4L::update_refresh]
