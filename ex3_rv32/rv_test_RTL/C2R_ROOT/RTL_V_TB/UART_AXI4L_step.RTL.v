...
/*-------------------------------------------------------------------------------------------------------------
final pipe layout
P( 1): 419 nodes,   1716.0 gates,  123 pipeRegs (   70 pipes,  217 states, 0 FBs), IO(  0,  2),GIO( 6, 4),D(  47.0),pd( 0, 0)
------------------------------------------ explicit pipe boundary -------------------------------------------
P( 2): 523 nodes,   1047.0 gates,    0 pipeRegs (    0 pipes,  191 states, 1 FBs), IO( 76,  0),GIO( 0, 2),D(  47.0),pd( 0, 1)
-------------------------------------------------------------------------------------------------------------
Total: 942 nodes,   2763.0 gates,  123 pipeRegs (   70 pipes,  408 states, 1 FBs), I( 76),O(  2),D(  94.0),maxD(  47.0 :   47.0)
Total    5876.5 gates (combined) :   2763.0 (comb-gates) +  479 (reg-bits) * 6.50 (gates/FF) + 0 memBits
-------------------------------------------------------------------------------------------------------------*/

/*-------------------------------------------------------------------------------------------------------------
[TOTAL] 942 nodes, 5,876.5 totalGates, 2,763 combGates, 479 regBits, 0 memBits, 0 totalMemBits
...
( 11) [ 25.850 -  28.200] : area(  175.0,   86.0),latency(   65.0,    6.0),carry(   49.0,    0.0),foSum(  134.000,  88.718,  79.139,    0),foAve(2.030,1.344,1.199,0.000),foStd(0.187,0.058,0.036),foNormL2(  20.591),nodeCount(    66)
...
( 15) [ 35.250 -  37.600] : area(  194.0,   88.0),latency(   68.0,   11.0),carry(   12.0,    0.0),foSum(  243.000, 111.427,  95.659,    0),foAve(2.793,1.281,1.100,0.000),foStd(0.794,0.115,0.064),foNormL2(  73.790),nodeCount(    87)
...
( 18) [ 42.300 -  44.650] : area(   46.0,    2.0),latency(   21.0,    2.0),carry(    0.0,    0.0),foSum(   69.000,  32.643,  28.852,    0),foAve(2.379,1.126,0.995,0.000),foStd(1.261,0.196,0.111),foNormL2(  38.743),nodeCount(    29)
( 19) [ 44.650 -  47.000] : area(    3.0,    0.0),latency(    3.0,    0.0),carry(    0.0,    0.0),foSum(    3.000,   3.000,   3.000,    0),foAve(0.231,0.231,0.231,0.000),foStd(0.117,0.117,0.117),foNormL2(   1.732),nodeCount(    13)
*/
...
(_UART_AXI4L_step : 5766.0 gates, 892 nodes) : 2763.0 comb-gates + 70 pipeBits + 392 stateBits + 0 FBBits
  (excl.sub-modules : 423.0 gates, 239 nodes) : 46.0 comb-gates + 40 pipeBits + 18 stateBits + 0 FBBits
  ...
  (_3_fsm_0 : 5330.0 gates, 646 nodes) : 2717.0 comb-gates + 30 pipeBits + 372 stateBits + 0 FBBits
    ...
    (_3_3_fsmWrite : 745.5 gates, 104 nodes) : 245.0 comb-gates + 2 pipeBits + 75 stateBits + 0 FBBits
      (excl.sub-modules : 737.5 gates, 83 nodes) : 237.0 comb-gates + 2 pipeBits + 75 stateBits + 0 FBBits
...
*********************************************************
                _3_2_fsmRead :     948.0 gates(acc:  16.44%),     259.0 comb-gates +    0 pipeBits + 106 stateBits +   0 FBBits
        _3_4_1_write_command :     941.5 gates(acc:  32.77%),     766.0 comb-gates +    2 pipeBits +  25 stateBits +   0 FBBits
               _3_3_fsmWrite :     737.5 gates(acc:  45.56%),     237.0 comb-gates +    2 pipeBits +  75 stateBits +   0 FBBits
                _3_4_2_do_rx :     700.0 gates(acc:  57.70%),     336.0 comb-gates +   18 pipeBits +  38 stateBits +   0 FBBits
                _3_4_3_do_tx :     623.0 gates(acc:  68.51%),     376.0 comb-gates +    1 pipeBits +  37 stateBits +   0 FBBits
              _3_4_fsmUser_2 :     561.5 gates(acc:  78.24%),     165.0 comb-gates +    3 pipeBits +  58 stateBits +   0 FBBits
                    _3_fsm_0 :     425.5 gates(acc:  85.62%),     211.0 comb-gates +    0 pipeBits +  33 stateBits +   0 FBBits
            _UART_AXI4L_step :     423.0 gates(acc:  92.96%),      46.0 comb-gates +   40 pipeBits +  18 stateBits +   0 FBBits
**********************************************************/
...
module UART_AXI4L_step_no_mem   (
  ...
  reg       _p1_CE_233, _p1_CE_237, _p1_CM_657, _p1_CM_697, _p1_CP_fsmUser_2_B1_F1, 
    _p1_CP_fsmUser_2_B1_F2, _p1_CP_fsmUser_2_B4_F2, _p1_CP_fsmWrite_B01_F04, 
    _p1_CP_fsmWrite_B01_F08, _p1_CP_write_command_B01_F2, _p1_DM_731, 
    _p1_G_axi_raddr_m_valid, _p1_G_axi_rdat_m_ready, _p1_I_do_rx_B10_1, 
    _p1_I_read_status_B1_09, _p1_I_write_command_B01_1, _p1_MA_740, 
...
function[ 7:0] _lut_G_HIDDEN_GLOBAL_57;
  input[ 3:0] idx0;
  case(idx0)
    4'd0  : _lut_G_HIDDEN_GLOBAL_57 = 8'h3c;
    4'd1  : _lut_G_HIDDEN_GLOBAL_57 = 8'h55;
    4'd2  : _lut_G_HIDDEN_GLOBAL_57 = 8'h41;
    4'd3  : _lut_G_HIDDEN_GLOBAL_57 = 8'h52;
    4'd4  : _lut_G_HIDDEN_GLOBAL_57 = 8'h54;
    4'd5  : _lut_G_HIDDEN_GLOBAL_57 = 8'h5f;
    4'd6  : _lut_G_HIDDEN_GLOBAL_57 = 8'h45;
    4'd7  : _lut_G_HIDDEN_GLOBAL_57 = 8'h58;
    4'd8  : _lut_G_HIDDEN_GLOBAL_57 = 8'h54;
    4'd9  : _lut_G_HIDDEN_GLOBAL_57 = 8'h2d;
    4'd10 : _lut_G_HIDDEN_GLOBAL_57 = 8'h31;
    4'd11 : _lut_G_HIDDEN_GLOBAL_57 = 8'h3e;
    4'd12 : _lut_G_HIDDEN_GLOBAL_57 = 8'h0;
    default : _lut_G_HIDDEN_GLOBAL_57 = 8'hx;
  endcase
endfunction /*_lut_G_HIDDEN_GLOBAL_57*/
...
wire       I_do_tx_B27_0        =  _p1_DM_731 & 1'h1                       ; // (NL) [F(0.0)<0>,B(1.0)<0>] <0,1> [U1] P2 OP(and:&)(rv32_io.cpp:L309)[UART::do_tx]
wire       G__this_uart_tx_irq  =  I_do_tx_B27_0                           ; // (NL) [F(0.0)<0>,B(1.0)<0>] <0,1> [U1] P2 OP(assign:=)(rv32_io.cpp:L309)[UART::do_tx]
...
wire       DM_655          =  (_p1_CP_fsmWrite_B01_F04) ? _p1_MA_740 : 1'h0; //  <FB>(L1.0+A1.0+fo1+ld[1:1]) [F(1.0)<0>,B(10.0)<0>] <0,1> [U1] P2 OP(sel:?)(./rv32_io.h:L547)(rv32_io.cpp:L618,L636)[UART_AXI4L::step]
wire       DM_656          =  (_p1_CP_fsmWrite_B01_F08) ? _p1_MA_740 : 1'h0; //  <FB>(L1.0+A1.0+fo1+ld[1:1]) [F(1.0)<0>,B(10.0)<0>] <0,1> [U1] P2 OP(sel:?)(./rv32_io.h:L547)(rv32_io.cpp:L618,L636)[UART_AXI4L::step]
wire       DM_658               =  DM_655 | DM_656                         ; //  <FB>(L1.0+A1.0+fo1+ld[1:1]) [F(2.0)<0>,B(9.0)<0>] <0,1> [U1] P2 OP(or:|)(./rv32_io.h:L547)(rv32_io.cpp:L618,L636)[UART_AXI4L::step]
...
wire       G__this_uart_id      =  (_p1_CM_657) ? DM_658 : DM_659          ; //  <FB>(L2.0+A2.0+fo4+ld[1:1:1]) [F(5.0)<1>,B(8.0)<0>] <0,1> [U1] P2 OP(sel:?)(./rv32_io.h:L547)(rv32_io.cpp:L618,L636)[UART_AXI4L::step]
...
/// (printf field...) wire[ 7:0] N_679               =  (QC_339) ? _lut_G_HIDDEN_GLOBAL_57 : 8'h0; //  <FB>(L1.0+A8.0+fo1+ld[8:1]) [F(9.0)<1>,B(3.0)<0>] <0,255> [U8] P2 OP(sel:?)(rv32_io.cpp:L464,L466)[UART::write_command]
...
wire       CP_fsmWrite_B01_F08  =  N_008 == 2'h2                           ; // GRP.28 <B>(L1.0+A1.0+fo3+ld[1]+S) [F(1.0)<0>,B(20.0)<1>] <0,1> [U1] P1 OP(eq:==)(rv32_io.cpp:L538)[AXI4L::SlaveFSM::fsmWrite]
wire       CP_fsmWrite_B01_F04  =  N_008 == 2'h1                           ; // GRP.28 <B>(L1.0+A1.0+fo3+ld[1]+S) [F(1.0)<0>,B(20.0)<1>] <0,1> [U1] P1 OP(eq:==)(rv32_io.cpp:L538)[AXI4L::SlaveFSM::fsmWrite]
...
wire[25:0] I_devWrite_1_B09_0   =  G__this_waddr/*prv*/[31:6]/*>>6*/       ; //  <B>(NL) [F(0.0)<0>,B(1.0)<0>] <0,67108863> [U26] P1 OP(shr:>>)(rv32_io.cpp:L636)[UART_AXI4L::devWrite]
wire       I_devWrite_1_B09_1   =  I_devWrite_1_B09_0[0]/*&1'h1*/          ; //  <B>(NL) [F(0.0)<0>,B(1.0)<0>] <0,1> [U1] P1 OP(and:&)(rv32_io.cpp:L636)[UART_AXI4L::devWrite]
wire       MA_740       =  (G_axi_wdat_m_valid) ? I_devWrite_1_B09_1 : 1'h0; //  <FB>(L1.0+A1.0+ld[1:1]) [F(1.0)<0>,B(1.0)<0>] <0,1> [U1] P1 OP(sel:?)(./rv32_io.h:L547)(rv32_io.cpp:L618,L636)[UART_AXI4L::step]
...
wire[ 2:0] I_write_command_B04_6 =  (I_write_command_B04_3) ? 3'h0 : I_write_command_B04_5; // GRP.28 <FB>(L1.0+A3.0+fo1+ld[3:0:1]) [F(14.0)<0>,B(1.0)<1>] <0,7> [U3] P1 OP(sel:?)(rv32_io.cpp:L462)[UART::write_command]
  ...
  if (rst_n == 1'b0) begin
    ...
    _p1_CP_fsmWrite_B01_F04                    <= 0;
    _p1_CP_fsmWrite_B01_F08                    <= 0;
    ...
    _p1_CP_fsmWrite_B01_F04                    <= CP_fsmWrite_B01_F04                ; /*   1 bits */
    _p1_CP_fsmWrite_B01_F08                    <= CP_fsmWrite_B01_F08                ; /*   1 bits */
    _p1_CP_write_command_B01_F2                <= CP_write_command_B01_F2            ; /*   1 bits */
    _p1_DM_731                                 <= DM_731                             ; /*   1 bits */
